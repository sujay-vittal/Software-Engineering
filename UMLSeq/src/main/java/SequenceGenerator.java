...
public class SequenceGenerator {	
	    ...
	    public void start() throws Exception {
	        ...
	        for (CompilationUnit compilationUnit : compilationunits) {
	            String className = "";
	            List<TypeDeclaration> typDeclaration = compilationUnit.getTypes();
	            for (Node n : typDeclaration) {
	                ClassOrInterfaceDeclaration classOrInterface = (ClassOrInterfaceDeclaration) n;
